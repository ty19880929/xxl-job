			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarmwechat_hook}<font color="black">*</font></label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="alarmWeChatWebhook" placeholder="${I18n.jobinfo_field_alarmwechat_hook_placeholder}" maxlength="100" ></div>
                    </div>
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarmwechat_hook}<font color="black">*</font></label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="alarmWeChatWebhook" placeholder="${I18n.jobinfo_field_alarmwechat_hook_placeholder}" maxlength="500" ></div>
                    </div>
